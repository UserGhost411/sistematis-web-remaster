<input type="hidden" id="access_privilege" value="<?= $privi->id ?>">
<div class="mb-3">
    ...
    <div class="aside-options">
        <div class="clearfix mt-4">
            <div class="form-check form-switch form-switch-lg">
                <input class="form-check-input me-0" id="access_r" type="checkbox" onchange="crud_disabled_all(this.checked)">
...
<div class="mb-3">
    <div class="aside-options">
        <div class="clearfix mt-4">
            <div class="form-check form-switch form-switch-lg">
                <input class="form-check-input me-0" id="access_c" type="checkbox">
...
<div class="mb-3">
    <div class="aside-options">
        <div class="clearfix mt-4">
            <div class="form-check form-switch form-switch-lg">
                <input class="form-check-input me-0" id="access_u" type="checkbox">
...
<div class="mb-3">
    <div class="aside-options">
        <div class="clearfix mt-4">
            <div class="form-check form-switch form-switch-lg">
                <input class="form-check-input me-0" id="access_d" type="checkbox">
