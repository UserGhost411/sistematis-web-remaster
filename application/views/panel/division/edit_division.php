<input type="hidden" id="division_id" value="<?= $data->id ?>">

<div class="mb-3">
    <label for="division_name" class="form-label">Division Name</label>
    <input type="text" class="form-control" id="division_name" value="<?= htmlspecialchars($data->division_name) ?>" placeholder="Enter Division Name" required>
</div>
<div class="mb-3">
