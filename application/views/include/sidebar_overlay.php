  ...
  <div class="sidebar-header bg-transparent p-0">
    <ul class="nav nav-underline nav-underline-primary" role="tablist">
      <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#timeline" role="tab">
          <svg class="icon">
            <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-list"></use>
          </svg></a></li>
      <li class="nav-item"><a class="nav-link" data-coreui-toggle="tab" href="#messages" role="tab">
          <svg class="icon">
            <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-speech"></use>
          </svg></a></li>
    ...
    <button class="sidebar-close" type="button" data-coreui-close="sidebar">
      <svg class="icon">
        <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-x"></use>
      </svg>
    </button>
  </div>
  <!-- Tab panes-->
    ...
    <div class="tab-pane active" id="timeline" role="tabpanel">
      <div class="list-group list-group-flush">
        ...
        <div class="list-group-item border-start-4 border-start-warning list-group-item-divider">
          <div class="avatar avatar-lg float-end"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/7.jpg") ?>" alt="user@email.com"></div>
          <div>Meeting with <strong>Lucas</strong></div><small class="text-medium-emphasis me-3">
            <svg class="icon">
              <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-calendar"></use>
            </svg> 1 - 3pm</small><small class="text-medium-emphasis">
            <svg class="icon">
              <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-location-pin"></use>
            </svg> Palo Alto, CA</small>
        </div>
        <div class="list-group-item border-start-4 border-start-info">
          <div class="avatar avatar-lg float-end"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/4.jpg") ?>" alt="user@email.com"></div>
          <div>Skype with <strong>Megan</strong></div><small class="text-medium-emphasis me-3">
            ...
            <svg class="icon">
              <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/brand.svg") ?>#cib-skype"></use>
            </svg> On-line</small>
        </div>
        ...
        <div class="list-group-item border-start-4 border-start-danger list-group-item-divider">
          <div>New UI Project - <strong>deadline</strong></div><small class="text-medium-emphasis me-3">
            ...
            <svg class="icon">
              <use xlink:href="<?= base_url("public/vendors/@coreui/icons/svg/free.svg") ?>#cil-home"></use>
            </svg> creativeLabs HQ</small>
          <div class="avatars-stack mt-2">
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/2.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/3.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/4.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/5.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/6.jpg") ?>" alt="user@email.com"></div>
          </div>
        </div>
        ...
        <div class="list-group-item border-start-4 border-start-primary list-group-item-divider">
          ...
          <div class="avatars-stack mt-2">
            ...
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/5.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/6.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/7.jpg") ?>" alt="user@email.com"></div>
            <div class="avatar avatar-xs"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/8.jpg") ?>" alt="user@email.com"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="tab-pane p-3" id="messages" role="tabpanel">
      <div class="message">
        <div class="py-3 pb-5 me-3 float-start">
          <div class="avatar"><img class="avatar-img" src="<?= base_url("public/assets/img/avatars/7.jpg") ?>" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
        </div>
      ...
      <div class="aside-options">
        <div class="clearfix mt-4">
          <div class="form-check form-switch form-switch-lg">
            <input class="form-check-input me-0" id="darkmode-switch" onchange="changeThemeSelect(this)" type="checkbox" checked="">
            <label class="form-check-label fw-semibold small" for="darkmode-switch">Dark Mode</label>
          </div>
        </div>
        <div><small class="text-medium-emphasis">Use Dark Theme for apply special screen setting designed to make the best use of dim light situations, particularly at night.</small></div>
      </div>
      <div class="aside-options">
        <div class="clearfix mt-3">
          <div class="form-check form-switch form-switch-lg">
            <input class="form-check-input me-0" id="disrend-switch" type="checkbox" onclick="handleAppSetting('display_app_render',(this.checked?1:0))">
            <label class="form-check-label fw-semibold small" for="disrend-switch">Show Render Time</label>
          </div>
        </div>
      </div>
      <div class="aside-options">
        <div class="clearfix mt-3">
          <div class="form-check form-switch form-switch-lg">
            <input class="form-check-input me-0" id="dismem-switch" onclick="handleAppSetting('display_app_memory',(this.checked?1:0))" type="checkbox">
            <label class="form-check-label fw-semibold small" for="dismem-switch">Show Memory Usage</label>
          </div>
        </div>
      </div>
      <div class="aside-options">
